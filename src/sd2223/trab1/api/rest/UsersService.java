...
public interface UsersService {
	 ...
	 * @return 200 the address of the user (name@domain). 409 if the userId already
	 *         exists. 400 otherwise.
	 */
	@POST
	 ...
	 *         the existing password; 403 if the password is incorrect; 404 if no
	 *         user exists with the provided userId 400 otherwise.
	 */
	@GET
	@Path("/{" + NAME + "}")
	@Produces(MediaType.APPLICATION_JSON)
